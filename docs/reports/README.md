# RECA Current Reports

本目录只保留仍用于解释当前批准基线、M0 完成事实和最终审计结论的报告与证据。
...
阶段性研究、文档拆分、安全政策优化、稳定标识旧快照和 M0 执行过程已移入 [文档归档](../archive/README.md)。归档内容保留当时结论，不定义当前政策。

## 上级入口

- [项目 README](../../README.md)
- [仓库开发规则](../../AGENTS.md)
- [开源集成总计划](../source-research/OPEN_SOURCE_INTEGRATION_MASTER_PLAN.md)
